...
function tediousExpressX(config) {
        ...
        return {
            ...
            __createRequest: function (ostream) {
                ...
                for (var index in this.parameters) {
                    request.addParameter(this.parameters[index].name, this.parameters[index].type || TYPES.NVarChar, this.parameters[index].value);
                }
                return request;
            },
...
exports.default = tediousExpressX;
//# sourceMappingURL=express4tediousX.js.map